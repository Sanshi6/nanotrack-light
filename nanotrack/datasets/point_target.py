...
class PointTarget:
    ...
    def __call__(self, target, size, neg=False):
        ...
        if neg:
            ...
            neg, neg_num = select(neg, self.cfg.TRAIN.NEG_NUM)
            cls[neg] = 0
        ...
        # sampling
        pos, pos_num = select(pos, self.cfg.TRAIN.POS_NUM)
        neg, neg_num = select(neg, self.cfg.TRAIN.TOTAL_NUM - self.cfg.TRAIN.POS_NUM)
