...
class MobileOne(nn.Module):
    ...
    def __init__(self,
        ...
        self.stage0 = MobileOneBlock(in_channels=3, out_channels=self.in_planes,
                                     kernel_size=3, stride=2, padding=1, inference_mode=self.inference_mode)
        ...
        self.stage4 = self._make_stage(int(512 * width_multipliers[3]), num_blocks_per_stage[3],
                                       num_se_blocks=num_blocks_per_stage[3] if use_se else 0, stride=False, use_act=True)
...
PARAMS = {
    "s0": {"width_multipliers": (0.75, 1.0, 1.0, 2.0),
           "num_conv_branches": 4,
           "use_se": False},
    "s1": {"width_multipliers": (1.5, 1.5, 1.5, 2.5),
           "num_conv_branches": 4,
           "use_se": True
           },
