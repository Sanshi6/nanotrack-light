...
class MobileRepV3(nn.Module):
    ...
    def __init__(self,
        ...
        self.stage1 = MobileOneBlock(in_channels=96, out_channels=576,
...
def RepMobileNetv3(**kwargs):
    ...
    cfgs = [  #
        ...
        # 16 -> 72 -> 24, ReLU, stride:2, kernel: 3, SE: False
        [16, 72, 3, 2, False, 'ReLU'],
        [72, 24, 3, 1, False, 'ReLU'],

        # 24 -> 88 -> 24, ReLU, stride:1, kernel:3, SE: False
        [24, 88, 3, 1, False, 'HS'],
        [88, 24, 3, 1, False, 'ReLU'],

        # 24 -> 96 -> 40, ReLU, stride:2, kernel:5, SE: True
        [24, 96, 5, 2, False, 'HS'],
        [96, 40, 3, 1, False, 'ReLU'],

        # 40 -> 240 -> 40, ReLU, stride:1, kernel:5, SE: True
        [40, 240, 5, 1, False, 'HS'],
        [240, 40, 3, 1, False, 'ReLU'],

        # 40 -> 240 -> 40, ReLU, stride:1, kernel:5, SE: True
        [40, 240, 5, 1, False, 'HS'],
        [240, 40, 3, 1, False, 'ReLU'],

        # 40 -> 120 -> 48, HS, stride:1, kernel:5, SE: True
        [40, 120, 5, 1, False, 'HS'],
        [120, 48, 3, 1, False, 'ReLU'],

        # 48 -> 144 -> 48, HS, stride:1, kernel:5, SE: True
        [48, 144, 5, 1, False, 'HS'],
        [144, 48, 3, 1, False, 'ReLU'],

        # 48 -> 288 -> 96, HS, stride:2, kernel:5, SE: True
        [48, 288, 5, 2, False, 'HS'],
        [288, 96, 3, 1, False, 'HS'],

        # 96 -> 576 -> 96, HS, stride:1, kernel:5, SE: True
        [96, 576, 3, 1, False, 'HS'],
        [576, 96, 3, 1, False, 'HS'],
    ...
    return MobileRepV3(cfg=cfgs, inference_mode=False, num_conv_branches=4)
