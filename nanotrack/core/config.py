...
__C.DATASET.VID = CN() 
__C.DATASET.VID.ROOT = 'data/ILSVRC2015/Data/VID/crop511'          # VID dataset path
__C.DATASET.VID.ANNO = 'data/ILSVRC2015/Data/VID/train.json'
__C.DATASET.VID.FRAME_RANGE = 100
__C.DATASET.VID.NUM_USE = 100000

__C.DATASET.YOUTUBEBB = CN()
__C.DATASET.YOUTUBEBB.ROOT = 'data/youtube/crop511'
__C.DATASET.YOUTUBEBB.ANNO = 'data/youtube/train.json'
...
__C.DATASET.DET = CN()
__C.DATASET.DET.ROOT = 'data/ILSVRC2015/Data/DET/crop511'
__C.DATASET.DET.ANNO = 'data/ILSVRC2015/Data/DET/train.json'
