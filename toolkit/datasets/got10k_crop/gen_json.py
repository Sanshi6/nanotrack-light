...
json.dump(train, open('/home/yl/datasets/GOT-10k/crop271/train.json', 'w'), indent=4, sort_keys=True)
json.dump(val, open('/home/yl/datasets/GOT-10k/crop271/val.json', 'w'), indent=4, sort_keys=True)
print('done!')
